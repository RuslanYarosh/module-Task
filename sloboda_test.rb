module Tasks
  ...
  def jenifer(x,y,n)
   ...
   if x<0 or y<0 or n<=0
      ...
      time_to_copy=[x,y].sort  
      k=time_to_copy[1].to_f/time_to_copy[0] # determine how much slower the second printer
      ...
      xerox2=xerocs_copy2*time_to_copy[1]+time_to_copy[0]  # time of slow Xerox
      xerox1=xerocs_copy1*time_to_copy[0]  # time of faster Xerox
